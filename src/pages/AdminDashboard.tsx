            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  ...
                  <th className="text-start p-4 font-semibold text-sm text-muted-foreground hidden md:table-cell">
                    {language === 'en' ? 'Areas' : 'المناطق'}
                  </th>
                  <th className="text-start p-4 font-semibold text-sm text-muted-foreground hidden lg:table-cell">
